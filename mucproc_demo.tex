...
\\
\\
Die daraus folgende typische Markov Annahme als Prozessdiagramm und Übergangstabelle:
\\
...
\\
\\
\noindent Ganz grundsätzlich haben wir es hier also mit einer Bedingten Wahrscheinlichkeit zu tun die wie folgend aussieht:
