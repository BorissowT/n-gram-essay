...
$N = 1$: 	\fbox{\raisebox{0pt}[0.3cm][0.05cm]{\strut This}}
			\fbox{\raisebox{0pt}[0.3cm][0.05cm]{\strut is}} 
			\fbox{\raisebox{0pt}[0.3cm][0.05cm]{\strut a}} 
			\fbox{\raisebox{0pt}[0.3cm][0.05cm]{\strut sentence}}.
...
\\
$N = 2$: 	\fbox{\raisebox{0pt}[0.3cm][0.05cm]{\strut This is}}
			\hspace{-0.6cm}\fbox{\hspace{0.4cm}\raisebox{0pt}[0.3cm][0.05cm]{\strut a}} 
			\hspace{-0.6cm}\fbox{\hspace{0.4cm}\raisebox{0pt}[0.3cm][0.05cm]{\strut sentence}}.
			\begin{tikzpicture}[baseline={(current bounding box.center)}]
				\coordinate (A) at (0,0.4);
				\coordinate (B) at (3,1);
				\coordinate (C) at (0,-0.2);
